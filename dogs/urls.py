...
from dogs.views import (index, BreedListView, DodBreedListView, DodListView, DogCreateView, DogDetailView,
...
urlpatterns = [
    ...
    path('breeds/<int:pk>/dogs/', DodBreedListView.as_view(), name='breed_dogs'),
